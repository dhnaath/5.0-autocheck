...
const DEFAULT_PROFILES: FuelProfile[] = [
  ...
  { name: "Biosolar", price: 6800, color: "gold" },
  { name: "Dexlite", price: 14550, color: "amber" },
  { name: "Pertamina Dex", price: 15100, color: "gold" },
];
...
export default function App() {
  ...
  useEffect(() => {
    localStorage.setItem("fc_initial_odometer", initialOdometer.toString());
  }, [initialOdometer]);
  ...
  const [motorType, setMotorType] = useState<"bensin" | "ev_hybrid" | "solar">(() => {
    const val = localStorage.getItem("fc_motor_type");
    if (val === "hybrid" || val === "ev") return "ev_hybrid";
    return (val as "bensin" | "ev_hybrid" | "solar") || "bensin";
  });
  ...
  useEffect(() => {
    if (fuelProfiles.length === 3) {
      const isOldDefault = fuelProfiles.every(
        (p) =>
          p.name === "Pertalite" ||
          p.name === "Pertamax" ||
          p.name === "Pertamax Turbo"
      );
      if (isOldDefault) {
  ...
  const [partFormNoPart, setPartFormNoPart] = useState<string>("");
  ...
  const saveIncome = () => {
    ...
    if (isNaN(total) || total <= 0) {
      alert(lang === "id" ? "Harap isi nominal harga / pendapatan." : "Please fill in the income amount.");
      return;
    }
          ...
          {!hasOnboarded ? (
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        >
                          <LucideIcons.Droplet className="w-4 h-4 sm:w-5 sm:h-5 stroke-[2]" />
                          <span>Solar</span>
                        </button>

                        {vehicleType === "mobil" && (
                          <button
                            onClick={() => setMotorType("ev_hybrid")}
                            className={`flex items-center justify-center gap-2 py-3.5 px-2 rounded-2xl border transition-all cursor-pointer font-bold text-xs sm:text-sm select-none ${
                              motorType === "ev_hybrid"
                                ? "border-[#3b82f6] text-[#3b82f6] bg-[#3b82f6]/10 shadow-[0_0_15px_rgba(59,130,246,0.15)]"
                                : "border-slate-800 text-slate-400 hover:border-slate-700 bg-[#0c0c0e]"
            ...
            <>
              ...
              <div className="flex-none bg-slate-50 px-4 pt-6 pb-4 border-b border-slate-200/50 z-30">
                {!isOnline && (
                  <div className="mb-3 bg-amber-50 border border-amber-200 text-amber-800 px-3.5 py-2.5 rounded-xl flex items-center gap-2.5 text-[11px] sm:text-xs font-bold animate-fade-in shadow-sm select-none">
                    ...
                    <span>
                      {lang === "id"
                        ? "Mode Offline — Data disimpan aman secara lokal"
                        : "Offline Mode — Data safely saved locally"}
                    </span>
                  </div>
                )}
                {activeTab === "fuel" && (
            ...
            {activeTab === "dashboard" && (
              <div className="px-4 flex flex-col flex-grow gap-6 animate-fade-in pt-4 pb-8">
                  ...
                  return (
                    <>
                      ...
                      <div className="flex flex-col flex-grow">
                        ...
                        <div className={`bg-white border border-slate-200 p-5 flex flex-col flex-grow gap-6 relative overflow-hidden ${
            ...
            {activeTab === "history" && (
              <div className="px-4 flex flex-col flex-grow gap-5 animate-fade-in pt-4 pb-8">
                <div className="flex flex-col flex-grow">
                  {/* Sub-tab toggle */}
                  <div className="flex w-full text-xs font-bold select-none relative z-10 -mb-[1px]">
                    <button
                  ...
                  return (
                    <div className={`bg-white border border-slate-200 p-4 flex flex-col flex-grow gap-4 overflow-y-auto scrollbar-hide pb-20 relative z-0 font-sans text-left ${
            ...
            {activeTab === "settings" && (
              <div className="px-4 flex flex-col gap-5 animate-fade-in relative flex-grow pt-4 pb-8">
                {settingsTab === "main" ? (
                  <>
                  ...
                  <>
                          ...
                          <div className="flex flex-col gap-5">
                            <div className="flex flex-col gap-2">
                              ...
                              <select
                                ...
                                className="py-3 px-4 bg-slate-50 text-slate-900 text-sm font-bold border border-slate-200 rounded-xl outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-100 transition-all"
                              >
                    ...
                    {settingsTab === "vehicle" && (
                      <div className="flex flex-col gap-3 mt-2 animate-fade-in flex-grow">
                        <span className="text-xs uppercase font-bold tracking-widest text-slate-400 block">
                          {t.sett_vehicle}
                        </span>
                        <div className="bg-white border border-slate-200 rounded-[20px] p-5 flex flex-col flex-grow gap-6 text-xs leading-none relative overflow-y-auto scrollbar-hide pb-20">
                          <div className="flex flex-col gap-2">
                            <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <div className="grid grid-cols-2 gap-3 mt-1">
                              ...
                              >
                                <LucideIcons.Car className="w-5 h-5 stroke-[2.5px]" />
                                <span>{lang === "id" ? "Mobil" : "Car"}</span>
                              </button>
                              <button
                              ...
                              >
                                {(() => {
                                  const IconComponent = LucideIcons.Bike;
                                  return IconComponent ? <IconComponent className="w-5 h-5 stroke-[2.5px]" /> : null;
                                })()}
                                <span>Motorbike</span>
                              </button>
                            </div>
                          ...
                          <div className="flex flex-col gap-2">
                            <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">
                             ...
                             <div className="grid grid-cols-2 gap-3 mt-1">
                               <button
                                 onClick={() => setMotorType("bensin")}
                                 className={`flex items-center justify-center gap-2 py-3 px-2 rounded-xl border text-sm font-bold transition-all cursor-pointer ${
                                   motorType === "bensin"
                                     ? "border-red-500 bg-red-50 text-red-600 shadow-sm"
                                     : "border-slate-200 text-slate-500 hover:border-slate-300 hover:bg-slate-50 hover:text-slate-800"
                                 }`}
                               >
                                 <LucideIcons.Fuel className="w-5 h-5 stroke-[2.5px]" />
                                 <span>Bensin</span>
                               </button>
                               <button
                                 onClick={() => setMotorType("solar")}
                               ...
                               >
                                 <LucideIcons.Droplet className="w-5 h-5 stroke-[2.5px]" />
                                 <span>Solar</span>
                               </button>
                               {vehicleType === "mobil" && (
                                 <button
                                 ...
                                 >
                                   <LucideIcons.Zap className="w-5 h-5 stroke-[2.5px]" />
                                   <span>PHEV / EV</span>
                                 </button>
                               )}
                             </div>
                          ...
                          <div className="flex flex-col gap-2 pt-4 border-t border-slate-100">
                            <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">
                              {lang === "id" ? "Odometer Awal (KM)" : "Initial Odometer (KM)"}
                            </label>
                            <input
                              type="number"
                          ...
                          <div className="flex flex-col gap-2">
                            <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">
                              Jumlah Bar Speedometer
                            </label>
                            <input
                              type="number"
                              value={maxBars || ""}
                              onChange={(e) => setMaxBars(parseInt(e.target.value) || 1)}
                              className="py-3 px-4 bg-slate-50 text-slate-900 text-sm font-bold border border-slate-200 rounded-xl outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-100 transition-all font-mono"
                            />
                          </div>
                          ...
                          <div className="flex flex-col gap-2 pt-4 border-t border-slate-100">
                            ...
                            <div className="grid grid-cols-2 gap-3 mt-1">
                              ...
                              >
                                <LucideIcons.Gauge className="w-5 h-5 stroke-[2.5px]" />
                                <span>{lang === "id" ? "Otomatis" : "Automatic"}</span>
                              </button>
                            </div>
                          </div>
                    ...
                    {settingsTab === "buttons" && (
                      <div className="flex flex-col gap-3 mt-2 animate-fade-in flex-grow">
                        ...
                        <div className="bg-white border border-slate-200 rounded-[20px] p-5 flex flex-col flex-grow gap-6 relative overflow-y-auto scrollbar-hide pb-20">
                          <div className="flex flex-col gap-5">
                            {nominalButtons.map((nominal, idx) => (
                              <div key={idx} className="flex flex-col gap-2">
                                ...
                                <div className="relative">
                                  <div className="absolute left-4 top-1/2 -translate-y-1/2 font-mono font-bold text-slate-400">
                                    {currency === "IDR" ? "Rp" : currency === "USD" ? "$" : currency === "EUR" ? "€" : currency === "SGD" ? "$" : currency === "MYR" ? "RM" : currency === "THB" ? "฿" : currency === "PHP" ? "₱" : currency === "AUD" ? "$" : currency === "JPY" ? "¥" : "£"}
                                  </div>
                                  <input
                                    type="number"
                                    value={nominal || ""}
                                    ...
                                    className="w-full py-3 pl-12 pr-4 bg-slate-50 text-slate-900 text-sm font-bold border border-slate-200 rounded-xl outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-100 transition-all font-mono"
                                  />
                                </div>
                              </div>
                            ))}
                          ...
                          <div className="flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                >
                                  ...
                                  <div className="flex gap-2">
                                    <button
                                      ...
                                      className="w-8 h-8 flex items-center justify-center bg-white border border-rose-200 hover:bg-rose-50 text-rose-600 rounded-lg transition-all cursor-pointer"
                                    >
                              ...
                              {incomePlatforms.length === 0 && (
                                <div className="text-sm text-slate-500 py-2 font-medium text-center border border-dashed border-slate-300 rounded-xl">
                          ...
                          <div className="flex flex-col gap-3 pt-4 border-t border-slate-100">
                            ...
                            <div className="flex gap-2">
                              <input
                                ...
                                className="flex-1 bg-slate-50 text-slate-900 text-sm font-bold py-3 px-4 rounded-xl border border-slate-200 outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-100 transition-all"
                              />
                              <button
                                onClick={() => {
                                  if (
                          ...
                          <div className="flex flex-col gap-3 pt-4 border-t border-slate-100">
                            <div className="flex flex-col gap-1">
                              ...
                              <p className="text-xs text-slate-400 font-medium">
                                Pilih maksimal 2 platform untuk ditampilkan
                              </p>
                            </div>
                            <div className="flex flex-col gap-2">
                              {incomePlatforms.map((plat, idx) => (
                                <label
                                  key={idx}
                                  className="flex items-center justify-between bg-slate-50 border border-slate-200 rounded-xl p-3 cursor-pointer"
                                >
                                  <span className="text-sm font-bold text-slate-800">
                                    {plat}
                                  </span>
                                  <input
                                    type="checkbox"
                                    className="w-5 h-5 text-indigo-600 rounded border-slate-300 focus:ring-indigo-500 accent-indigo-500"
                        ...
                        <div className="bg-white border border-slate-200 rounded-[20px] p-5 flex flex-col flex-grow gap-6 relative overflow-y-auto scrollbar-hide pb-20">
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <button
                              ...
                              className="w-full bg-white border border-orange-200 hover:bg-orange-50 text-orange-600 font-bold text-sm tracking-wider uppercase py-4 px-5 rounded-xl transition-all cursor-pointer flex items-center justify-center gap-2"
                            >
                              <RefreshCw className="w-5 h-5" />
                              {lang === "id"
                                ? "Reset Kalibrasi"
                            ...
                            <p className="text-xs text-slate-400 text-center font-medium mt-1">
                              Berguna jika perhitungan efisiensi (KM/L) terlihat tidak akurat.
                            </p>
                          </div>
                          ...
                          <div className="flex flex-col gap-2 pt-5 border-t border-slate-100">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              <button
                                ...
                                className="w-full bg-slate-50 border border-slate-200 hover:bg-slate-100 text-slate-700 font-bold text-sm tracking-wider uppercase py-4 px-3 rounded-xl transition-all cursor-pointer flex items-center justify-center gap-2"
                              >
                                <Download className="w-5 h-5" />
                                {lang === "id" ? "Backup" : "Backup"}
                              </button>
                              <label className="w-full bg-slate-50 border border-slate-200 hover:bg-slate-100 text-slate-700 font-bold text-sm tracking-wider uppercase py-4 px-3 rounded-xl transition-all cursor-pointer flex items-center justify-center gap-2 m-0 text-center relative overflow-hidden">
                                <Upload className="w-5 h-5 shrink-0" />
                                <span className="truncate">
                                  {lang === "id" ? "Restore" : "Restore"}
                                </span>
                                <input
                                  type="file"
                                  accept=".json"
                            ...
                            <p className="text-xs text-slate-400 text-center font-medium mt-1">
                              Simpan data secara berkala untuk menghindari kehilangan histori.
                            </p>
                          </div>

                          <div className="flex flex-col gap-2 pt-5 border-t border-slate-100 mt-4">
                            <h3 className="text-xs font-bold text-rose-500 uppercase tracking-wider">
                              Zona Berbahaya
                            </h3>
                            <button
                              id="danger-delete-all-logs-action"
                              onClick={handleResetWipeData}
                              className="w-full bg-white border border-rose-200 hover:bg-rose-50 hover:border-rose-300 text-rose-600 font-bold text-sm tracking-wider uppercase py-4 px-5 rounded-xl transition-all cursor-pointer flex items-center justify-center gap-2"
                            >
                              <Trash2 className="w-5 h-5" />
                              {lang === "id"
                                ? "Hapus Semua Data"
                            ...
                            <p className="text-xs text-rose-400 text-center font-medium mt-1">
                  ...
                  <div className="bg-slate-900 text-white py-4 px-5 flex justify-between items-center select-none">
                    ...
                    <div className="flex flex-col gap-4 bg-white p-4 rounded-2xl border border-slate-200">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h4 className="text-sm font-extrabold text-slate-800 uppercase tracking-wider">Info Utama</h4>
                      </div>
                      
                      <div className="flex flex-col gap-2">
                        <label className="text-xs font-bold text-slate-600">Nama Komponen:</label>
                        <input
                          type="text"
                          value={partFormName}
                          onChange={(e) => setPartFormName(e.target.value)}
                          placeholder="Busi"
                          className="w-full bg-slate-50 border border-slate-200 text-slate-900 text-sm font-bold py-3 px-4 rounded-xl outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-100 transition-all"
                        />
                      </div>
                      <div className="flex gap-4">
                        <div className="flex flex-col gap-2 flex-1 w-1/2">
                          <label className="text-xs font-bold text-slate-600">Merk/Tipe:</label>
                          <input
                            type="text"
                            value={partFormMerk}
                        ...
                        <div className="flex flex-col gap-2 flex-1 w-1/2">
                          <label className="text-xs font-bold text-slate-600">Kode Part:</label>
                          <input
                            type="text"
                            value={partFormNoPart}
                            onChange={(e) => setPartFormNoPart(e.target.value)}
                    ...
                    <div className="flex flex-col gap-4 bg-white p-4 rounded-2xl border border-slate-200">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h4 className="text-sm font-extrabold text-slate-800 uppercase tracking-wider">Lifespan & Biaya</h4>
                      </div>
                      
                      <div className="flex gap-4">
                        <div className="flex flex-col gap-2 flex-1 w-1/2">
                          <label className="text-xs font-bold text-slate-600">Usia Komponen (KM):</label>
                          <input
                            type="number"
                            value={partFormLifespan}
                            onChange={(e) => setPartFormLifespan(e.target.value)}
                            placeholder="10000"
                            className="w-full bg-slate-50 border border-slate-200 text-slate-900 text-sm font-bold py-3 px-4 rounded-xl outline-none focus:border-emerald-500 focus:bg-white focus:ring-2 focus:ring-emerald-100 transition-all"
                          />
                        </div>
                        <div className="flex flex-col gap-2 flex-1 w-1/2">
                      ...
                      <div className="flex flex-col gap-2">
                        <label className="text-xs font-bold text-slate-600">Biaya / KM (Estimasi):</label>
                        <div className="w-full bg-emerald-50 border border-emerald-100 text-emerald-700 text-sm font-bold py-3 px-4 rounded-xl select-none flex items-center justify-between overflow-hidden">
                          <span className="truncate">
                            {(() => {
                          ...
                          <span className="text-xs font-bold text-emerald-500 ml-2 whitespace-nowrap">/ KM</span>
                        </div>
                      </div>
                    </div>

                    {/* SECTION: Tracking Saat Ini */}
                    <div className="flex flex-col gap-4 bg-white p-4 rounded-2xl border border-slate-200">
                      <div className="flex items-center gap-2 mb-1">
                        <div className="bg-amber-100 p-1.5 rounded-lg text-amber-600">
                          <LucideIcons.Activity className="w-4 h-4" />
                        </div>
                        <h4 className="text-sm font-extrabold text-slate-800 uppercase tracking-wider">Status Pemakaian</h4>
                      </div>
                      
                      <div className="flex gap-4">
                        <div className="flex flex-col gap-2 flex-1 w-1/2">
                          <label className="text-xs font-bold text-slate-600 whitespace-nowrap overflow-hidden text-ellipsis">Terakhir Servis (Odo):</label>
                          <input
                            type="number"
                            value={partFormLastOdo}
                            onChange={(e) => setPartFormLastOdo(e.target.value)}
                            placeholder="15400"
                            className="w-full bg-slate-50 border border-slate-200 text-slate-900 text-sm font-bold py-3 px-4 rounded-xl outline-none focus:border-amber-500 focus:bg-white focus:ring-2 focus:ring-amber-100 transition-all"
                          />
                        </div>
                        <div className="flex flex-col gap-2 flex-1 w-1/2">
                          <label className="text-xs font-bold text-slate-600 whitespace-nowrap overflow-hidden text-ellipsis">Sisa Usia (KM):</label>
                          <input
                            type="number"
                            value={(() => {
                      ...
                      <div className="flex flex-col gap-2 mt-2">
                        <div className="flex justify-between items-end">
                          <label className="text-xs font-bold text-slate-600">Kondisi Sekarang (%):</label>
                        ...
                        <input
                          ...
                          className="w-full accent-amber-500 h-2.5 bg-slate-100 border border-slate-200 rounded-lg appearance-none cursor-pointer"
                        />
                        <p className="text-[10px] text-slate-400 font-medium text-center mt-1">
                          Geser slider untuk menyesuaikan kondisi saat ini
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 bg-white p-4 rounded-2xl border border-slate-200">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h4 className="text-sm font-extrabold text-slate-800 uppercase tracking-wider">Lainnya</h4>
                      </div>
                      
                      <div className="flex flex-col gap-2">
                        <label className="text-xs font-bold text-slate-600">Catatan Tambahan:</label>
                        <textarea
                          value={partFormNotes}
                          onChange={(e) => setPartFormNotes(e.target.value)}
                          placeholder="Catatan..."
                          rows={2}
                          className="w-full bg-slate-50 border border-slate-200 text-slate-900 text-sm font-bold py-3 px-4 rounded-xl outline-none focus:border-slate-400 focus:bg-white focus:ring-2 focus:ring-slate-100 resize-none transition-all"
                        />
                      </div>
                      <div className="flex flex-col gap-2">
                        <label className="text-xs font-bold text-slate-600">Ikon Kategori:</label>
                        <div className="mt-1 h-[220px] overflow-y-auto w-full bg-slate-50 border border-slate-200 rounded-xl p-3">
                            ...
                            {SPARE_PART_ICONS.map((ico) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`w-12 h-12 rounded-xl border-2 flex items-center justify-center transition-all shrink-0 ${partFormIcon === ico ? "bg-indigo-50 border-indigo-500 text-indigo-600 shadow-sm" : "bg-white border-slate-200 text-slate-500 hover:border-slate-300 hover:bg-slate-50 hover:text-slate-800"}`}
                                  aria-label={ico}
                                  title={ico}
                                >
                ...
                >
                  <div className="bg-[#0f172b] text-white py-4 px-5 flex justify-between items-center select-none">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold tracking-tight">
                        {lang === "id" ? "Catat Pendapatan" : "Record Income"}
                      </span>
                    </div>
                  </div>
                  <div className="p-5 flex flex-col gap-4 bg-slate-50 overflow-y-auto">
                    <div className="flex flex-col gap-2">
                      <label className="text-xs font-bold text-slate-700 leading-tight">
                    ...
                    <div className="flex flex-col gap-2">
                      <label className="text-xs font-bold text-slate-700 leading-tight">
                        {lang === "id" ? "Nominal / Harga Pendapatan (Rp)" : "Income Amount / Price"}
                      </label>
                      <input
                        type="number"
                        value={incomeTotal}
                        onChange={(e) => handleIncomeTotalChange(e.target.value)}
                        placeholder="50000"
                        className="w-full bg-white border border-slate-200 text-slate-900 text-sm font-bold py-3 px-4 rounded-xl outline-none focus:border-slate-800 focus:ring-1 focus:ring-slate-800"
                      />
                    </div>
                    <div className="flex flex-col gap-2">
                      <label className="text-xs font-bold text-slate-700 leading-tight">
                        {lang === "id" ? "Total Jarak Tempuh (KM) - Opsional" : "Total Distance (KM) - Optional"}
                      </label>
                      <input
                        type="number"
                        value={incomeDistance}
                        onChange={(e) => handleIncomeDistanceChange(e.target.value)}
                        placeholder="12.5"
                        className="w-full bg-white border border-slate-200 text-slate-900 text-sm font-bold py-3 px-4 rounded-xl outline-none focus:border-slate-800 focus:ring-1 focus:ring-slate-800"
                      />
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <textarea
                        ...
                        placeholder={lang === "id" ? "Catatan opsional..." : "Optional notes..."}
                        className="w-full bg-white border border-slate-200 text-slate-900 text-sm font-bold py-3 px-4 rounded-xl outline-none focus:border-slate-800 focus:ring-1 focus:ring-slate-800 resize-none h-20"
                      />
                    </div>
                  </div>
                  <div className="p-4 bg-white border-t border-slate-100 flex gap-3">
                    {selectedIncomeForEdit && (
                      <button
                        onClick={() => {
                          if (confirm(lang === "id" ? "Hapus pendapatan ini?" : "Delete this income?")) {
                    ...
                    <button
                      onClick={() => {
                        saveIncome();
                        if (parseFloat(incomeTotal) > 0) setShowIncomeModal(false);
                      }}
                ...
                >
                  <div className="bg-[#0f172b] text-white py-4 px-5 flex justify-between items-center select-none">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold tracking-tight">
                        {lang === "id" ? "Catat Pengeluaran" : "Record Expense"}
                      </span>
                    </div>
                  </div>
                  <div className="p-5 flex flex-col gap-4 bg-slate-50 overflow-y-auto">
                    ...
                    <div className="flex flex-col gap-2">
                      <label className="text-xs font-bold text-slate-700 leading-tight">
                        {lang === "id" ? "Nominal / Harga Pengeluaran (Rp)" : "Expense Amount / Price"}
                      </label>
                      <input
                        type="number"
                        value={expenseCost}
                    ...
                    <div className="flex flex-col gap-2">
                      <label className="text-xs font-bold text-slate-700 leading-tight">
                        {lang === "id" ? "Platform / Kategori" : "Platform / Category"}
                      </label>
                      <select
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <textarea
                        ...
                        placeholder={lang === "id" ? "Parkir, Tol, Cuci Mobil..." : "Parking, Toll, Car wash..."}
                        className="w-full bg-white border border-slate-200 text-slate-900 text-sm font-bold py-3 px-4 rounded-xl outline-none focus:border-slate-800 focus:ring-1 focus:ring-slate-800 resize-none h-20"
                      />
                    </div>
                  </div>
                  <div className="p-4 bg-white border-t border-slate-100 flex gap-3">
                    {selectedExpenseForEdit && (
                      <button
                        onClick={() => {
                          if (confirm(lang === "id" ? "Hapus pengeluaran ini?" : "Delete this expense?")) {
                    ...
                    <button
                      onClick={() => {
                        handleSaveExpense();
                        if (parseFloat(expenseCost) > 0) setShowExpenseModal(false);
                      }}
                      className="flex-1 py-3 bg-rose-600 text-white font-bold rounded-xl hover:bg-rose-700 transition-colors text-sm"
                    >
                      {lang === "id" ? "Simpan" : "Save"}
                    </button>
                  </div>
